            ...
            <div class="col-sm-12">
                ...
                <?php if (isset($orderSuccess) && $orderSuccess): ?>
                    <div class="alert alert-success" style="font-size:1.2em;">
                        <strong>Ваше замовлення успішно оформлено!</strong><br>
                        <a href="/user/profile" class="btn btn-primary" style="margin-top:15px;">Перейти в профіль</a>
                    </div>
                <?php else: ?>
                    <?php if (!empty($errors)): ?>
                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            ...
                            <form method="post" action="/cart/checkout">
                                ...
                                <button type="submit" name="submit" class="btn btn-success btn-lg" style="background:#a259e6; border:0;">Оформити замовлення</button>
                            </form>
                        </div>
